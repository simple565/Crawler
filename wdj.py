...
def get_info_wdj(key_word):
    ...
    url = 'https://www.wandoujia.com/wdjweb/api/category/more?catId=5029&page={}'.format(pageIndex)
    ...
    total_page = 9
    # total_page = json.loads(html)['data']['totalPage']
    # print('总页数：{}'.format(total_page))
    ...
    # 创建进度条并开始运行
    pbar = progressbar.ProgressBar(maxval=total_page, widgets=widgets).start()
